...
const defaultRecipes = [
  // BREAKFAST RECIPES
  {
    ...
    cuisine: "American",
    difficulty: "Easy",
    utensils: JSON.stringify(["Bowl", "Microwave", "Measuring cup"]),
    baseServings: 1,
    instructions:
  ...
  },
  {
    ...
    difficulty: "Easy",
    utensils: JSON.stringify(["Bowl", "Spoon"]),
    baseServings: 1,
    instructions:
    ...
    ingredients: [
      ...
      },
      {
        ...
        fatPer100g: 20.3,
        gramsPerBase: 30,
        allergens: JSON.stringify(["Gluten", "Tree Nuts"]),
      },
      {
  ...
  // LUNCH RECIPES
  {
    ...
    cuisine: "American",
    difficulty: "Medium",
    utensils: JSON.stringify(["Grill pan", "Large bowl", "Tongs", "Knife"]),
    baseServings: 1,
    instructions:
  ...
  },
  {
    ...
    cuisine: "Mediterranean",
    difficulty: "Medium",
    utensils: JSON.stringify(["Saucepan", "Bowl", "Strainer"]),
    baseServings: 1,
    instructions:
  ...
  // DINNER RECIPES
  {
    ...
    difficulty: "Medium",
    utensils: JSON.stringify(["Baking sheet", "Parchment paper", "Knife"]),
    baseServings: 1,
    instructions:
  ...
  },
  {
    ...
    cuisine: "Asian",
    difficulty: "Medium",
    utensils: JSON.stringify(["Wok", "Spatula", "Knife", "Cutting board"]),
    baseServings: 1,
    instructions:
  ...
  // SNACK RECIPES
  {
    ...
    cuisine: "American",
    difficulty: "Easy",
    utensils: JSON.stringify(["Knife", "Plate"]),
    baseServings: 1,
    instructions:
  ...
  // SHAKE RECIPES
  {
    ...
    cuisine: "American",
    difficulty: "Easy",
    utensils: JSON.stringify(["Blender", "Measuring cup"]),
    baseServings: 1,
    instructions:
